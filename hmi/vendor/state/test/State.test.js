  ...
  describe('State', () => {
    ...
    describe('#listen', () => {
      ...
      it('listen to changes', () => {
        ...
        testStore.action('change_state', (state, data) => {
      ...
      it('called with part of the state', () => {
        ...
        testStore.action('change_state', state => state.lvl1.lvl2.lvl3, (state) => {
          return Object.assign({}, state, {
            a: 11,
          })
        })
      ...
      it('only called when state changes', () => {
        ...
        testStore.listen([state => state.lvl1.lvl2.lvl3, state => state.lvl1, state => state], (lvl3, lvl1) => {
        ...
        testStore.action('change_state', state => state, (state) => {
          return Object.assign({}, state, {
            propA: 'B',
          })
        })
      ...
      it('call when child gets replaced', () => {
        ...
        testStore.action('change_child_obj', (state) => {
          return Object.assign({}, state, {
            lvl1: {
              a: 'a',
              b: 'b',
    ...
    describe('#dispatch', () => {
      ...
      it('pass parameters', () => {
        const initialState = testStore.getState()
        testStore.action('change_propA', (state, data) => {
          return Object.assign({}, state, {
            propA: data,
          })
        })
      ...
      it('pass object', () => {
        const initialState = testStore.getState()
        testStore.action('change_propA_to_obj', (state, data) => {
          return Object.assign({}, state, {
            propA: object,
          })
        })
    ...
    describe('#action', () => {
      it('change array element', () => {
        ...
        testStore.action('change_array_element', (state, data) => {
          return Object.assign({}, state, {
      ...
      it('use state filters to change array element', () => {
        ...
        testStore.action('change_array_element_using_filter', state => state.lvl1.arr, (arr, data) => {
      ...
      it('use state filters to change nested object', () => {
        const initialState = testStore.getState()
        testStore.action('change_nested_object_using_filter', state => state.lvl1.lvl2.lvl3, (lvl3, data) => {
          return Object.assign({}, lvl3, {
            c: 'C added',
          })
        })
      ...
      it('remove object from array', () => {
        ...
        testStore.action('remove_object_from_array', state => state.lvl1.objArr, (objArr, data) => {
      ...
      it('add object', () => {
        ...
        testStore.action('add_object', state => state, (state, data) => {
          return Object.assign({}, state, {
            newProp: 'yea',
          })
        })
      ...
      it('change primitive propery using selector', () => {
        ...
        testStore.action('change_prop', state => state.propA, (propA) => {
          return 'B'
        })
